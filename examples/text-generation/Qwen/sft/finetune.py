...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(
        ...
        self.tokenizer = tokenizer
        self.raw_data = json.load(open(data_path))
...
def train():
    ...
    if model.config.model_type == "qwen2" and model_args.use_flash_attention:
    ...
    trainer = GaudiTrainer(
        model=model, gaudi_config=gaudi_config, tokenizer=tokenizer, args=training_args, train_dataset=data_module
    )
